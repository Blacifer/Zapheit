...
export const PARTNER_APP_CATALOG: MarketplaceApp[] = [
  ...
  },
  {
    id: 'gupshup',
    name: 'Gupshup',
    developer: 'Gupshup Technology India Pvt. Ltd.',
    category: 'communication',
    description: 'Conversational messaging API platform supporting WhatsApp, SMS, RCS, and more. Agents can send notifications, collect responses, and run automated conversation flows.',
    permissions: ['Send messages', 'Read message status', 'Read conversation logs'],
    relatedAgentIds: [],
    actionsUnlocked: ['Send WhatsApp messages', 'Send SMS', 'Read delivery status', 'Trigger conversation flows'],
    setupTimeMinutes: 4,
    bundleIds: ['communication-stack'],
    installMethod: 'api_key',
    requiredFields: [
      { name: 'api_key', label: 'API Key', type: 'password', placeholder: 'Your Gupshup API key', required: true },
      { name: 'app_name', label: 'App Name', type: 'text', placeholder: 'Your Gupshup app name', required: true },
    ],
    installCount: 1840,
    featured: false,
    badge: 'India Priority',
