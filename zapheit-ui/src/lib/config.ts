export type ZapheitFrontendConfig = {
  apiUrl: string;
  supabaseUrl: string;
...
declare global {
  interface Window {
    __ZAPHEIT_CONFIG__?: Partial<ZapheitFrontendConfig>;
  }
}
...
export function getFrontendConfig(): ZapheitFrontendConfig {
  const runtime = (typeof window !== 'undefined' ? window.__ZAPHEIT_CONFIG__ : undefined) || {};
