...
interface HubSpotActivityTabProps {
  connectorId?: string;
}

export function HubSpotActivityTab({ connectorId = 'hubspot' }: HubSpotActivityTabProps) {
  ...
  return (
    <div className="p-4">
      <ActivityFeed
        ...
        loading={loading}
        maxItems={50}
        emptyMessage="No HubSpot activity yet. Actions will appear here once the integration is active."
      />
    </div>
  );
}
