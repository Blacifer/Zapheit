...
export const APP_BUNDLES: AppBundle[] = [
  ...
  },
  {
    ...
    appIds: ['stripe', 'cashfree', 'quickbooks', 'xero'],
    colorHex: '#DC2626',
    icon: 'HandCoins',
  },
  {
  ...
  },
  {
    ...
    appIds: ['cashfree', 'paytm-business', 'cashfree', 'cashfreex'],
    colorHex: '#DC2626',
    icon: 'HandCoins',
  },
];
...
export const PARTNER_APP_CATALOG: MarketplaceApp[] = [
  ...
  },
  {
    id: 'cashfree',
    name: 'Cashfree',
    developer: 'Cashfree Software Pvt. Ltd.',
    category: 'finance',
    ...
    requiredFields: [
      ...
      { name: 'key_secret', label: 'Key Secret', type: 'password', placeholder: 'Your Cashfree key secret', required: true },
    ],
    installCount: 2410,
    featured: true,
  ...
  },
  {
    ...
    developer: 'Cashfree Software Pvt. Ltd.',
    category: 'finance',
    description: 'Automated payroll and banking platform by Cashfree. Agents can monitor payroll runs, verify disbursements, and ensure statutory compliance like PF and TDS.',
    ...
    requiredFields: [
      ...
      { name: 'api_secret', label: 'API Secret', type: 'password', placeholder: 'Your CashfreeX API secret', required: true },
    ],
    installCount: 1950,
    featured: false,
    badge: 'India Priority',
