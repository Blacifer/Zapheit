...
export const PHASE5_INTEGRATIONS: IntegrationSpec[] = [
  ...
  },
  {
    ...
    endpoints: {
      ...
      portfolios: { method: 'GET', path: '/api/1.0/portfolios' },
      teams: { method: 'GET', path: '/api/1.0/teams' },
    },
    capabilities: {
      reads: ['productivity.tasks', 'productivity.projects', 'productivity.portfolios', 'productivity.teams'],
      writes: [
        { id: 'productivity.task.create', label: 'Create task', risk: 'low' },
        { id: 'productivity.task.update', label: 'Update task', risk: 'low' },
        { id: 'productivity.task.delete', label: 'Delete task', risk: 'medium' },
        { id: 'productivity.project.update', label: 'Update project', risk: 'low' },
        { id: 'productivity.story.create', label: 'Add comment/story', risk: 'low' },
        { id: 'productivity.attachment.upload', label: 'Upload attachment', risk: 'low' },
      ],
    },
  },
  {
