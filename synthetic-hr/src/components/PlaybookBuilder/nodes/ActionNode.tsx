...
const CONNECTOR_COLORS: Record<string, string> = {
  slack: 'border-pink-400 dark:border-pink-600',
  jira: 'border-blue-400 dark:border-blue-600',
  github: 'border-slate-400 dark:border-slate-500',
  hubspot: 'border-orange-400 dark:border-orange-600',
  quickbooks: 'border-green-400 dark:border-green-600',
  'google-workspace': 'border-red-400 dark:border-red-600',
  'zoho-people': 'border-yellow-400 dark:border-yellow-600',
  notion: 'border-slate-300 dark:border-slate-600',
};

export const ActionNode = memo(({ data, selected }: NodeProps<ActionNodeData>) => {
  const borderColor = data.integration
    ? CONNECTOR_COLORS[data.integration] || 'border-purple-300 dark:border-purple-700'
