...
interface QuickBooksActivityTabProps {
  connectorId?: string;
}

export function QuickBooksActivityTab({ connectorId = 'quickbooks' }: QuickBooksActivityTabProps) {
  ...
  return (
    <div className="p-4">
      <ActivityFeed
        ...
        loading={loading}
        maxItems={50}
        emptyMessage="No QuickBooks activity yet. Actions will appear here once the integration is active."
      />
    </div>
  );
}
