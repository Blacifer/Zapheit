...
interface NotionActivityTabProps {
  connectorId?: string;
}

export function NotionActivityTab({ connectorId = 'notion' }: NotionActivityTabProps) {
  ...
  return (
    <div className="p-4">
      <ActivityFeed
        ...
        loading={loading}
        maxItems={50}
        emptyMessage="No Notion activity yet. Actions will appear here once the integration is active."
      />
    </div>
  );
}
