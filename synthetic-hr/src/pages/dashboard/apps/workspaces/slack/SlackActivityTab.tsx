...
export function SlackActivityTab({ connectorId = 'slack', onApprovalResolved }: SlackActivityTabProps) {
  ...
  return (
    <div className="p-4">
      <GovernanceActivityFeed
        ...
        loading={loading}
        maxItems={50}
        emptyMessage="No Slack activity yet. Actions will appear here once the integration is active."
