...
export function GitHubActivityTab({ connectorId = 'github' }: GitHubActivityTabProps) {
  ...
  return (
    <div className="p-4">
      <ActivityFeed
        ...
        loading={loading}
        maxItems={50}
        emptyMessage="No GitHub activity yet. Actions will appear here once the integration is active."
      />
    </div>
  );
}
