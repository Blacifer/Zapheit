...
/**
 * Load Testing Framework with SLO Validation (JavaScript version)
 * 
 ...
 */
function recordRequest(metrics, status, latency, isRateLimited = false) {
 ...
 */
async function runLoadTest(apiKey, concurrentUsers = 10, requestsPerUser = 10) {
  console.log('\n╔════════════════════════════════════════════════════════════╗');
 ...
 */
async function runRateLimitTest(apiKey) {
  console.log('\n╔════════════════════════════════════════════════════════════╗');
...
async function main() {
  ...
  try {
    // Run load test
    const loadTestMetrics = await runLoadTest(apiKey, 10, 10);
